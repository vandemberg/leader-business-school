        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Cadastro - {{ $invitation->platform->name ?? 'Plataforma' }}</h4>
                </div>

                <div class="card-body">
                    <p class="text-muted">Você foi convidado para se cadastrar na plataforma <strong>{{ $invitation->platform->name ?? 'nossa plataforma' }}</strong>.</p>
                    <p class="text-muted mb-4">Preencha os dados abaixo para completar seu cadastro:</p>
                    ...
                    <form method="POST" action="{{ route('invite.register.store', ['token' => $invitation->token]) }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Este é o e-mail do convite</small>
                            </div>
                        </div>
